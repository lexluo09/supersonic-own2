...
public class DatasourceYamlManager {
    ...
    public static DimensionYamlTpl convert(Dim dim) {
        ...
        if (dim.getTypeParams() != null) {
            ...
            dimensionTimeTypeParamsTpl.setIs_primary(dim.getTypeParams().getIsPrimary());
            dimensionTimeTypeParamsTpl.setTime_granularity(dim.getTypeParams().getTimeGranularity());
            dimensionYamlTpl.setType_params(dimensionTimeTypeParamsTpl);
        }
