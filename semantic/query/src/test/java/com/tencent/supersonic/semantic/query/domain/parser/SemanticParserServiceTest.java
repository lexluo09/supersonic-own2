...
class SemanticParserServiceTest {
    ...
    public void test() throws Exception {
        ...
        measure2.setExpr("1");
        measure2.setCreate_metric("true");
        ...
        measure3.setExpr("uv");
        measure3.setCreate_metric("true");
        ...
        dimensionTimeTypeParams.setIs_primary("true");
        dimensionTimeTypeParams.setTime_granularity("day");
        dimension.setType_params(dimensionTimeTypeParams);
        ...
        dimensionTimeTypeParams2.setIs_primary("true");
        dimensionTimeTypeParams2.setTime_granularity("day");
        dimension2.setType_params(dimensionTimeTypeParams2);
        ...
        dimensionTimeTypeParams3.setIs_primary("true");
        dimensionTimeTypeParams3.setTime_granularity("day");
        dimension3.setType_params(dimensionTimeTypeParams3);
    ...
    private static void addDepartment(SemanticSchema semanticSchema) {
        ...
        DimensionTimeTypeParamsTpl dimensionTimeTypeParams3 = new DimensionTimeTypeParamsTpl();
        dimensionTimeTypeParams3.setIs_primary("true");
        dimensionTimeTypeParams3.setTime_granularity("week");
        dimension3.setType_params(dimensionTimeTypeParams3);
        dimensions.add(dimension3);
